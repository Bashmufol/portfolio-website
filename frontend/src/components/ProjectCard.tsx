  ...
  return (
    ...
    >
      <div className="mb-4 flex items-start justify-between gap-3">
        <h3 className="text-lg font-semibold text-white group-hover:text-copper-light">
          {project.title}
        </h3>
      ...
      <div className="mb-5 flex flex-wrap gap-2">
        {project.tech.map((tech) => (
          <span
            key={tech}
            className="rounded-md bg-slate-muted/80 px-2 py-1 font-mono text-xs text-slate-300"
          >
            {tech}
          </span>
        ))}
      ...
      <div className="flex gap-3 border-t border-slate-border/40 pt-4">
        {project.github && (
          <a
            ...
            className="inline-flex items-center gap-1.5 text-sm text-slate-400 transition-colors hover:text-copper-light"
          >
        ...
        {project.demo && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 text-sm text-slate-400 transition-colors hover:text-teal-glow"
          >
